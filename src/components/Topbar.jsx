...
export default function Topbar({ title = 'Dashboard' }) {
  ...
  // Define which pages should show the Add Candidate button
  const showAddCandidateButton = ['/app/dashboard', '/app/candidates'].includes(location.pathname);
  ...
  const getQuickActionButton = () => {
    switch (location.pathname) {
      ...
      case '/app/candidates':
        return {
          text: 'Add Candidate',
          action: () => navigate('/app/candidates'), // Could open a modal or form
          icon: Plus
        };
      case '/app/calendar':
        return {
